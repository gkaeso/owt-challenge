...
alter table contact_skill_assoc
    add constraint fk_contact_skill_assoc_contact_id foreign key (contact_id) references contact;

alter table contact_skill_assoc
    add constraint fk_contact_skill_assoc_skill_id foreign key (skill_id) references skill;